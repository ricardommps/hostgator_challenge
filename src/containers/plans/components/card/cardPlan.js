...
const CardPlan = ({ featured, styleBuyButton, plan, cycleSelected, icon }) => {
    ...
    <WrapCard>
      ...
      <Card className={!featured ? classes.root : classes.rootFeatured}>
        ...
        <CardActions className={classes.footer}>
          <Typography className={classes.textFooter} style={{ borderBottom: '1px dashed #9eb8dc' }}>
